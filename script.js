...
submitButton1.onclick = () => {
  ...
  if (numberInput1 < 0 || numberInput1 > 100) {
    ...
    message1 = "Invalid input. Please enter a number between 0 and 100.";
  }
...
submitButton2.onclick = () => {
  ...
  switch (true) {
    case isNaN(numberInput2):
      message2 = "Invalid input. Please enter a valid number.";
      break;
    ...
    case numberInput2 >= 90 && numberInput2 <= 100:
      ...
      break;
    default:
      message2 = "Invalid input. Please enter a number between 0 and 100.";
  }
